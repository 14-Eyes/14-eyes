/**
 * ChildAlert Component
 *
 * Informs the user they are about to enter Child Mode, a simplified experience for children.
 * Provides a button to navigate to the `ChildNavigator` route.
 *
 * Key Features:
 * - Clear instructional message
 * - Single action button to confirm mode switch
 * - Centered layout with accessible styling
 *
