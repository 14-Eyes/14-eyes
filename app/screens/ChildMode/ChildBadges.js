/**
 * ChildBadges Component
 *
 * Placeholder screen for future badge tracking feature in Child Mode.
 * Displays a "Coming Soon!" message and a back button to return to `CHILD_HOME`.
 *
 * Key Features:
 * - Simple layout with centered message
 * - Uses `ChildBackButton` for child-friendly navigation
 *
