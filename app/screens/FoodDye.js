 ...
 * FoodDye Component
 *
 * Displays a list of artificial food dyes from `badlists.js` for educational reference.
 * Uses `AppText` for consistent styling and a centered layout with blue accents.
 *
