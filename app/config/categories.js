...
export default {
    foodCategories: [
        ...
        },
        {
            ...
            pageDesc: "Adding spices to food can enhance the taste and increase the amount of vitamins and minerals. Listed below are commonly available and harvested spices, along with their vitamins and minerals.",
            buttonColor: "#F43545",
            mapToo: foodz.spices,
        },
        {
        ...
        },
        {
            ...
            pageDesc: "Meats provide many important vitamins and minerals for your body, with protein being one of the biggest factors. They should be eaten cooked to avoid parasites or illness. Listed below are commonly available and hunted meats, along with their vitamins and minerals.",
            buttonColor: "#F786AA",
            mapToo: foodz.meat,
        },
        {
        ...
        },
        {
            ...
            pageDesc: "Bread provides many vitamins and minerals for your body, and comes in many different delicious forms. Listed below are commonly available bread products, along with their vitamins and minerals. However, be aware that bread contains carbohydrates, which turn into extra sugar in your body.",
            buttonColor: "#FAD717",
            mapToo: foodz.breads,
        },
        {
    ...
    harmfulCategories: [
        {
            ...
            pageDesc: "Certain sugars are bad for your body because they spike blood sugar levels and can easily be overconsumed, leading to health problems and negative effects on your body. Below are common sugars that are harmful to your body and why.",
            buttonColor: "#8acff4",
        ...
        },
        {
            ...
            pageDesc: "Preservatives are bad for your body because they are usually made through artificial means, leading to health problems and negative effects on the body. Below are common preservatives and why they harm your body.",
            buttonColor: "#00BA71",
        ...
        },
        {
            ...
            pageDesc: "Certain food dyes are bad for your body because they are usually made from synthetic chemicals that are linked to health problems, and most provide no nutritional benefits to your body. Below are common food dyes and why they harm your body.",
            buttonColor: "#FAD717",
