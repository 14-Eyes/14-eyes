...
export default {
    ...
    harmfulCategories: [
        ...
        },
        {
            ...
            pageDesc: "Certain preservatives are bad for your body because they are usually made through artificial means, leading to health problems and negative effects on the body. Below are common preservatives and why they harm your body.",
            buttonColor: "#00BA71",
