/**
 * This code defines structured datasets for allergies, medical conditions, and nutrition tips used throughout the app's health analysis features.
 * 
 * - `allergyChoices` lists common allergens that users can select to personalize food safety checks.
 * - `conditionChoices` maps health conditions to ingredients to avoid and beneficial nutrients, supporting tailored dietary recommendations.
 * - `cathyTips` offers colorful, food-based health facts to educate and motivate users in a playful, engaging way.
 * 
